    ...
    stages {
        ...
        stage('Deploying') {
            steps {
                ...
                sh 'gcloud compute scp /var/lib/jenkins/workspace/pipeline_main/index.html saqlainalishah_official@saqlain-appache-jenkins:/var/www/html --zone=us-central1-a'
